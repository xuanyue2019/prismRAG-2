...
setup(
    name="prismrag-2",
    version="0.1.0",
    author="PrismRAG-2 Team",
    author_email="prismrag@example.com",
    description="PrismRAG-2: Improving RAG Factuality through Distractor Resilience and Strategic Reasoning",
